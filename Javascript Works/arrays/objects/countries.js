var countries= [
 ...
 for(let country of countries){
    ...
    //console.log(`Country Name:${countryName} Capital:${countCapital} Population:${countPopulation} Currency: ${countCurrency}`);
    //let cntryData=countryName:countryName,capital:capital,currency:currency,population:population //object created
    let cntryData={countryName,capital,currency,population}; //since key:value of object have same name no need to give them both explicitly
    myCountries.push(cntryData);

 }
 //console.log(myCountries);
 
 //Qn1:print all country name
 //myCountries.forEach(data=>console.log(data.countryName));
 
 //Qn2:print details of India
 //console.log((myCountries.find(data=>data.countryName=="India")));

 //Qn3: print currency name of china 
 let chinaCurrency=myCountries.find(data=>data.countryName=="China").currency
 //console.log(chinaCurrency);

 //Qn4: print countries  having population > 2Cr
 //console.log(myCountries.filter(data=>data.population>20000000)); 
 
 //Qn4.1: print countries name having population > 2Cr
 console.log(myCountries.filter(data=>data.population>20000000).map(data=>data.countryName));